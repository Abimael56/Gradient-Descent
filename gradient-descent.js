...
function gradientDescent(elt, w, h, numPoints, learningRate) {
	...
	//Error normal de distibución.
	var error = d3.random.normal(0, stddev);
	
	//Puntos (x,y) aleatorios.
	...
	//Difenrecia entre el valor predicho y el valor real para un punto en especifico.
	function predictionError(point) {
		return hypothesis(point.x) - point.y;
	}
	
	//Error cuadrado de un punto especifico.
	function squaredError(point) {	
		return Math.pow(predictionError(point), 2);
	}
	
	//Error cuadrático medio para todos los puntos.
	...
	//Derivada parcial de la función de costo para theta0.
	...
	//Derivada parcial de la función para theta1.
	...
	function update() {
		...
		// Dibujar y actualizar la linea de regresión.
		...
		// Dibujar los circulos de la función de costo.
	...
	// La función principal inicia el algoritmo y hace una iteracion cada 100 milisegundos.
	function initialize() {
		
		// Inicializar centroides y puntos aleatorios.
